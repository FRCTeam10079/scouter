    ...
    >
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.section}>
          ...
          <CounterRow
            label={`Makes (Fuel) +${ballIncrement}`}
            value={form.autoMake}
            step={ballIncrement}
            onChange={(v: number) =>
              setForm((p: any) => ({
                ...p,
                autoMake: Math.max(0, p.autoMake + v),
              }))
            }
          />
          <CounterRow
            ...
            onChange={(v: number) =>
              setForm((p: any) => ({
                ...p,
                autoMiss: Math.max(0, p.autoMiss + v),
              }))
            }
          />
        ...
        <View style={styles.section}>
          ...
          <CounterRow
            label={`Hits (Fuel) +${ballIncrement}`}
            value={form.teleMake}
            step={ballIncrement}
            onChange={(v: number) =>
              setForm((p: any) => ({
                ...p,
                teleMake: Math.max(0, p.teleMake + v),
              }))
            }
          />
          <CounterRow
            ...
            onChange={(v: number) =>
              setForm((p: any) => ({
                ...p,
                teleMiss: Math.max(0, p.teleMiss + v),
              }))
            }
          />
          <CounterRow
            label={`Ferry Volume +${ballIncrement}`}
            value={form.teleFerry}
            step={ballIncrement}
            onChange={(v: number) =>
              setForm((p: any) => ({
                ...p,
                teleFerry: Math.max(0, p.teleFerry + v),
              }))
            }
          />
        ...
        climb:
          form.autoClimb === "Yes"
            ...
            : form.autoClimb === "Fail"
              ...
              : "NONE",
        passes:
          form.autoPassVol === "High"
            ? 3
            : form.autoPassVol === "Med"
              ? 2
              : form.autoPassVol === "Low"
                ? 1
                : 0,
