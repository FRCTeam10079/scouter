      ...
      {viewingSaved ? (
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity
            style={[
              styles.toggleBtn,
              form.hasDrumShooter && styles.activeGreen,
            ]}
            onPress={() =>
              setForm({ ...form, hasDrumShooter: !form.hasDrumShooter })
            }
          >
          ...
          <View style={styles.row}>
            ...
            <TextInput
              ...
              keyboardType="numeric"
              value={form.width}
              onChangeText={(t) => setForm({ ...form, width: t })}
            />
            <TextInput
              style={[styles.input, { flex: 1 }]}
          ...
          >
            <Text style={styles.toggleText}>
              Are they able to Ferry? {form.canFerry ? "YES" : "NO"}
            </Text>
          </TouchableOpacity>
